...
$("#generateotp").click(function(){
	 var $form = $("#regform");
	 var a = $form.find('input[name="mobile"]').val();
	// alert(a);
     var formData = {
...
$("#createaccountbutton").click(function(){
   ...
   var formData = {
  	mobile: $form.find('input[name="mobile"]').val(),
  	verificationCode: $form.find('input[name="password"]').val()
...
$("#verifyotp").click(function(){
    ...
    var formData = {
   	mobile: $form.find('input[name="mobile"]').val(),
   	verificationCode: $form.find('input[name="verification"]').val()
